...
//Если в двух словах, это "системная" библиотека, которая "управляет" приложениями. Благодаря ей можно обращаться к памяти, изменять её и тп
//Почитать инфу о сущности этой библиотеки можно тут - https://ru.nex-software.com/chto-takoe-kernel32dll